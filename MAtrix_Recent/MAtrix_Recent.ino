...
byte holder;
int alphabet=19; //number of letters using
...
#define G {B11001,B01111,B01100,B01101,B10001}
...
byte phrase[][5]={H,A,P,P,Y,blank,B,I,R,T,H,D,A,Y,blank,O,M,A,R};
  ...
  for(int i=5;i<matrixLength;i++){ 
    ...
    for(long h=0;h<100;h++){
      for(int row=0;row<5;row++){
        ...
        //11/17 Recent change to get rid of ghost light
        allOff(10);
        showLights();
        nextRow(row);
        //
